    ...
    render() {
        return (
            <div className="container">
                <div className="wbdv-privacy">
                    <h1 className="text-center">Privacy Policy for Film Finder</h1>

                    <br/>

                    <p>At Film Finder, accessible from
                        https://cs5610-film-finder-api.herokuapp.com/,
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for
                        ...
                        and/or
                        collect in Film Finder. This policy is not applicable to any information
                    ...
                    <p>The personal information that you are asked to provide, and the reasons why
                        you
                        are asked to provide it, will be made clear to you at the point we ask you
                        to
                        provide your personal information.</p>
                    <p>If you contact us directly, we may receive additional information about you
                        such
                        as your name, email address, phone number, the contents of the message
                        and/or
                    ...
                    <h2>Log Files</h2>
                    <p>Film Finder follows a standard procedure of using log files. These files log
                        ...
                        Our Privacy Policy was created with the help of the <a
                            ...
                            Generator</a> and the <a href="https://www.privacypolicytemplate.net/">Privacy
                            Policy Template</a>.</p>
                    <h2>Cookies and Web Beacons</h2>
                    <p>Like any other website, Film Finder uses 'cookies'. These cookies are used to
                    ...
                    <p>You may consult this list to find the Privacy Policy for each of the
                        advertising
                        partners of Film Finder.</p>
                    <p>Third-party ad servers or ad networks uses technologies like cookies,
                        JavaScript,
                        or Web Beacons that are used in their respective advertisements and links
                        that
                        appear on Film Finder, which are sent directly to users' browser. They
                        ...
                        visit.</p>
                    <p>Note that Film Finder has no access to or control over these cookies that are
                        used by third-party advertisers.</p>
                    <h2>Third Party Privacy Policies</h2>
                    <p>Film Finder's Privacy Policy does not apply to other advertisers or websites.
                        ...
                        find
                        a complete list of these Privacy Policies and their links here: Privacy
                        Policy
                        Links.</p>
                    ...
                    <p>Film Finder does not knowingly collect any Personal Identifiable Information
                        from
                ...
                <button className="btn btn-block btn-dark" onClick={this.readMore} id="myButton">Read More</button>
