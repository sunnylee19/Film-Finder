    ...
    render() {
        return (
            <div>
                ...
                <p>At Film Finder, accessible from https://cs5610-film-finder-api.herokuapp.com/,
                    one of our main priorities is the privacy of our visitors. This Privacy Policy
                    document contains types of information that is collected and recorded by Film
                ...
                <p>The right to restrict processing – You have the right to request that we restrict
                ...
                <p>The right to data portability – You have the right to request that we transfer
                ...
                <p>Film Finder does not knowingly collect any Personal Identifiable Information from
